"""
Django settings for TrafficLens project.
...
SECRET_KEY = 'django-insecure-7vmd+*#rmzau_l)dzwp46dwc$mf^c3sf(iy!0!$@lmzvbt**$f'
...
WSGI_APPLICATION = 'TrafficLens.wsgi.application'
...
EMAIL_HOST_USER = os.getenv('TRAFFIC-LENS_EMAIL_HOST_USER')

# Email Host App Password
EMAIL_HOST_PASSWORD = os.getenv('TRAFFIC-LENS_EMAIL_HOST_PASSWORD')
EMAIL_USE_TLS = False
EMAIL_USE_SSL = True
